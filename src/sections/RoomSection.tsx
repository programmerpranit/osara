    ...
    <>
      <div className="bg-secondary py-20 ">
        <div className="mx-auto max-w-7xl text-center">
          <h4 className=" text-primary ">Staycation</h4>
...
const Room = ({ image, title, subtitle, desc }: IRoom): JSX.Element => {
  return (
    <div className="p-5 md:w-1/2">
      <div className="rounded-sm border-b-4 border-b-primary bg-white">
